...
<body>
    <div class="app app-auth-sign-in align-content-stretch d-flex flex-wrap justify-content-end">
        ...
        <div class="app-auth-container">
            ...
            <?php endif; unset($_SESSION['register_complete']); unset($_SESSION['register_name']) ?>
            <!-- register complete msg -->
            ...
            <?php endif; unset($_SESSION['login_unsuccess']); ?>
            <!-- register complete msg -->
            
            <form action="manage.php" method="POST">
            <div class="auth-credentials m-b-xxl">
                <label for="signInEmail" class="form-label">Email address</label>
                <input type="text" class="form-control m-b-md" name="email" placeholder="example@neptune.com" value="<?php echo (isset($_SESSION['register_email'])) ? $_SESSION['register_email'] : "" ; unset($_SESSION['register_email']) ?>">
