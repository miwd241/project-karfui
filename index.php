...
<head>
    ...
    <title>Md Raisul Islam Rony - Personal Portfolio HTML Template</title>
                        ...
                        <div class="main-menu">
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <a href="index.html" class="navbar-brand logo-sticky-none">
                                    <p style="font-size: 30px; line-height:26px;">Rai<span style="color:#fff">sul</span></p>
                                </a>
                                <a href="index.html" class="navbar-brand s-logo-none">
                                    <p style="font-size: 30px; line-height:26px;">Rai<span style="color:#000">sul</span></p>
                                </a>
                ...
                <div class="row align-items-center">
                    <div class="col-xl-7 col-lg-6">
                        <div class="banner-content">
                            ...
                            <?php if (isset($_SESSION['author_id'])) : ?>
                                <!-- <?= $user['name'] ?> -->
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Raisul Islam Rony </h2>
                            <?php else : ?>
                                <!-- <?= $user['name'] ?> -->
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am Raisul Islam Rony </h2>
                            <?php endif; ?>
                            <p class="wow fadeInUp" data-wow-delay="0.6s">I'm Raisul Islam Rony, professional web developer with long time experience in this field​.</p>
                            <div class="banner-social wow fadeInUp" data-wow-delay="0.8s">
                                <ul>
                                    <li><a href="https://www.facebook.com/risul.rony.3" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="https://x.com/i/flow/login" target="_blank"><i class="fab fa-twitter"></i></a></li>
                                    <li><a href="https://www.instagram.com/ronyrisul/?hl=en" target="_blank"><i class="fab fa-instagram"></i></a></li>
        ...
        <section id="about" class="about-area primary-bg pt-120 pb-120">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <img src="./img.png" title="me-01" alt="me-01">
                        </div>
                    </div>
                    <div class="col-lg-6 pr-90">
                        ...
                        <div class="about-content">
                            <p>
                            I Am Raisul Islam Rony, I am a diploma student.My father name is MD.Aftub usddin.He is a army.MY mother name is MIST. Rozina Akter.she is a house wife . I have one bother and one sistir. consectetur adipisicing elit. Rerum, sed repudiandae odit deserunt, quas
                            quibusdam necessitatibus nesciunt eligendi esse sit non reprehenderit quisquam asperiores maxime
                            blanditiis culpa vitae velit. Numquam!Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum, sed repudiandae odit deserunt, quas
                            quibusdam necessitatibus nesciunt eligendi esse sit non reprehenderit quisquam asperiores maxime
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center mb-70">
                            ...
                            <div class="img-service" style="display: flex; justify-content:space-between; align-items:center; gap:20px;">

                                <img src="./service1.jpg" alt="service" width="50%"  hight="50%">
                                <img src="./service2.jpg" alt="service" width ="50%" hight="50%">
                                <img src="./service3.jpg" alt="service" width ="50%" hight="50%">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-8">
                        ...
                        <div class="img-service" style="display: flex; justify-content:space-between; align-items:center; gap:30px;">

                                <img src="./service.jpg" alt="service" width="65%"  hight="40%">
                                <img src="./service2.jpg" alt="service" width ="50%" hight="40%">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="contact-content">
                                ...
                                <div class="contact-list">
                                    <ul>
                                        <li><i class="fas fa-map-marker"></i><span>Address :</span>Rajshahi</li>
                                        <li><i class="fas fa-headphones"></i><span>Phone :</span>+01771123229</li>
                                        <li><i class="fas fa-globe-asia"></i><span>e-mail :</span>risulislamrony4@gmail.com</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>Copyright© <span>Rony</span> | All Rights Reserved</p>
                        </div>
                    </div>
                </div>
            </div>
